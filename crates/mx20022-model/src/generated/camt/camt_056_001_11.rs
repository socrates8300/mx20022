...
impl crate::common::validate::Validatable for Document {
    fn validate_constraints(
        ...
        self.fi_to_fi_pmt_cxl_req
            .validate_constraints(&format!("{path}/FIToFIPmtCxlReq"), violations);
    }
}
...
impl crate::common::validate::Validatable for FIToFIPaymentCancellationRequestV11 {
    fn validate_constraints(
        ...
        if let Some(ref val) = self.case {
            val.validate_constraints(&format!("{path}/Case"), violations);
        }
        if let Some(ref val) = self.ctrl_data {
            val.validate_constraints(&format!("{path}/CtrlData"), violations);
        }
        for (i, item) in self.undrlyg.iter().enumerate() {
            item.validate_constraints(&format!("{path}/Undrlyg[{i}]"), violations);
        }
...
impl crate::common::validate::Validatable for OriginalGroupHeader21 {
    fn validate_constraints(
        ...
        if let Some(ref val) = self.grp_cxl_id {
            val.validate_constraints(&format!("{path}/GrpCxlId"), violations);
        }
        if let Some(ref val) = self.case {
            val.validate_constraints(&format!("{path}/Case"), violations);
        }
        ...
        if let Some(ref val) = self.grp_cxl {
            val.validate_constraints(&format!("{path}/GrpCxl"), violations);
        }
        for (i, item) in self.cxl_rsn_inf.iter().enumerate() {
            item.validate_constraints(&format!("{path}/CxlRsnInf[{i}]"), violations);
        }
    }
}
...
impl crate::common::validate::Validatable for PaymentTransaction155 {
    fn validate_constraints(
        ...
        if let Some(ref val) = self.cxl_id {
            val.validate_constraints(&format!("{path}/CxlId"), violations);
        }
        if let Some(ref val) = self.case {
            val.validate_constraints(&format!("{path}/Case"), violations);
        }
        ...
        if let Some(ref val) = self.assgnr {
            val.validate_constraints(&format!("{path}/Assgnr"), violations);
        }
        if let Some(ref val) = self.assgne {
            val.validate_constraints(&format!("{path}/Assgne"), violations);
        }
        for (i, item) in self.cxl_rsn_inf.iter().enumerate() {
            item.validate_constraints(&format!("{path}/CxlRsnInf[{i}]"), violations);
        }
...
impl crate::common::validate::Validatable for UnderlyingTransaction34 {
    fn validate_constraints(
        ...
        if let Some(ref val) = self.orgnl_grp_inf_and_cxl {
            val.validate_constraints(&format!("{path}/OrgnlGrpInfAndCxl"), violations);
        }
        for (i, item) in self.tx_inf.iter().enumerate() {
            item.validate_constraints(&format!("{path}/TxInf[{i}]"), violations);
        }
    }
}
