...
impl TryFrom<String> for ExternalClaimNonReceiptRejection1Code {
    type Error = crate::common::validate::ConstraintError;
    #[allow(clippy::unreadable_literal)]
    fn try_from(value: String) -> Result<Self, Self::Error> {
        {
...
impl From<ExternalClaimNonReceiptRejection1Code> for String {
    fn from(v: ExternalClaimNonReceiptRejection1Code) -> Self {
        v.0
    }
}
/// Minimum length: 1
...
impl TryFrom<String> for ExternalInvestigationExecutionConfirmation1Code {
    type Error = crate::common::validate::ConstraintError;
    #[allow(clippy::unreadable_literal)]
    fn try_from(value: String) -> Result<Self, Self::Error> {
        {
...
impl From<ExternalInvestigationExecutionConfirmation1Code> for String {
    fn from(v: ExternalInvestigationExecutionConfirmation1Code) -> Self {
        v.0
    }
}
/// Minimum length: 1
...
impl TryFrom<String> for ExternalPaymentCancellationRejection1Code {
    type Error = crate::common::validate::ConstraintError;
    #[allow(clippy::unreadable_literal)]
    fn try_from(value: String) -> Result<Self, Self::Error> {
        {
...
impl From<ExternalPaymentCancellationRejection1Code> for String {
    fn from(v: ExternalPaymentCancellationRejection1Code) -> Self {
        v.0
    }
}
/// Minimum length: 1
...
impl TryFrom<String> for ExternalPaymentCompensationReason1Code {
    type Error = crate::common::validate::ConstraintError;
    #[allow(clippy::unreadable_literal)]
    fn try_from(value: String) -> Result<Self, Self::Error> {
        {
...
impl From<ExternalPaymentCompensationReason1Code> for String {
    fn from(v: ExternalPaymentCompensationReason1Code) -> Self {
        v.0
    }
}
/// Minimum length: 1
...
impl TryFrom<String> for ExternalPaymentModificationRejection1Code {
    type Error = crate::common::validate::ConstraintError;
    #[allow(clippy::unreadable_literal)]
    fn try_from(value: String) -> Result<Self, Self::Error> {
        {
...
impl From<ExternalPaymentModificationRejection1Code> for String {
    fn from(v: ExternalPaymentModificationRejection1Code) -> Self {
        v.0
    }
}
/// Minimum length: 1
...
impl crate::common::validate::Validatable for Charges6 {
    fn validate_constraints(
        ...
        if let Some(ref val) = self.ttl_chrgs_and_tax_amt {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/TtlChrgsAndTaxAmt");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
...
impl crate::common::validate::Validatable for ChargesRecord3 {
    fn validate_constraints(
        ...
        if let Some(ref val) = self.chrg_incl_ind {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/ChrgInclInd");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
...
impl crate::common::validate::Validatable for ClaimNonReceipt2 {
    fn validate_constraints(
        ...
        {
            let snap = violations.len();
            self.dt_prcd.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/DtPrcd");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.orgnl_nxt_agt {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/OrgnlNxtAgt");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
...
impl crate::common::validate::Validatable for Compensation4 {
    fn validate_constraints(
        ...
        {
            let snap = violations.len();
            self.rsn.inner.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/Rsn");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
...
impl crate::common::validate::Validatable for CorrectiveGroupInformation1 {
    fn validate_constraints(
        ...
        {
            let snap = violations.len();
            self.msg_nm_id.validate_constraints("", violations);
            if violations.len() > snap {
...
impl crate::common::validate::Validatable for CorrectiveInterbankTransaction3 {
    fn validate_constraints(
        ...
        {
            let snap = violations.len();
            self.intr_bk_sttlm_dt.validate_constraints("", violations);
            if violations.len() > snap {
...
impl crate::common::validate::Validatable for CorrectivePaymentInitiation5 {
    fn validate_constraints(
        ...
        {
            let snap = violations.len();
            self.instd_amt.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/InstdAmt");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
...
impl crate::common::validate::Validatable for Document {
    fn validate_constraints(
        ...
        {
            let snap = violations.len();
            self.rsltn_of_invstgtn.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/RsltnOfInvstgtn");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
    ...
    fn validate_constraints(
        ...
        match self {
            ...
            Self::AssgnmtCxlConf(inner) => {
                ...
                inner.validate_constraints("", violations);
                if violations.len() > snap {
                    let pfx = format!("{path}/AssgnmtCxlConf");
                    for v in &mut violations[snap..] {
                        v.path.insert_str(0, &pfx);
                    }
                }
...
impl crate::common::validate::Validatable for OriginalGroupHeader14 {
    fn validate_constraints(
        ...
        if let Some(ref val) = self.orgnl_grp_cxl_id {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/OrgnlGrpCxlId");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.grp_cxl_sts {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/GrpCxlSts");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        }
        for (idx, elem) in self.cxl_sts_rsn_inf.iter().enumerate() {
            let snap = violations.len();
            elem.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/CxlStsRsnInf[{idx}]");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        }
        for (idx, elem) in self.nb_of_txs_per_cxl_sts.iter().enumerate() {
            let snap = violations.len();
            elem.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/NbOfTxsPerCxlSts[{idx}]");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
...
impl crate::common::validate::Validatable for OriginalPaymentInstruction43 {
    fn validate_constraints(
        ...
        if let Some(ref val) = self.orgnl_pmt_inf_cxl_id {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/OrgnlPmtInfCxlId");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.pmt_inf_cxl_sts {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/PmtInfCxlSts");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
...
impl crate::common::validate::Validatable for PaymentTransaction139 {
    fn validate_constraints(
        ...
        if let Some(ref val) = self.orgnl_instd_amt {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/OrgnlInstdAmt");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref wrapper) = self.orgnl_reqd_exctn_dt {
            ...
            wrapper.inner.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/OrgnlReqdExctnDt");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.orgnl_reqd_colltn_dt {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/OrgnlReqdColltnDt");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
...
impl crate::common::validate::Validatable for PaymentTransaction147 {
    fn validate_constraints(
        ...
        {
            let snap = violations.len();
            self.orgnl_grp_inf.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/OrgnlGrpInf");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
        ...
        for (idx, elem) in self.mod_sts_rsn_inf.iter().enumerate() {
            let snap = violations.len();
            elem.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/ModStsRsnInf[{idx}]");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.rsltn_rltd_inf {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/RsltnRltdInf");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
...
impl crate::common::validate::Validatable for ResolutionOfInvestigationV12 {
    fn validate_constraints(
        ...
        {
            let snap = violations.len();
            self.sts.inner.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/Sts");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        }
        for (idx, elem) in self.cxl_dtls.iter().enumerate() {
            let snap = violations.len();
            elem.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/CxlDtls[{idx}]");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref wrapper) = self.clm_non_rct_dtls {
            ...
            wrapper.inner.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/ClmNonRctDtls");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
...
impl crate::common::validate::Validatable for StatementResolutionEntry4 {
    fn validate_constraints(
        ...
        if let Some(ref val) = self.orgnl_stmt_id {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/OrgnlStmtId");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.crrctd_amt {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/CrrctdAmt");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        }
        for (idx, elem) in self.chrgs.iter().enumerate() {
            let snap = violations.len();
            elem.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/Chrgs[{idx}]");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
