...
/// Builder for [`Charges12`]. Construct via [`Charges12::builder()`].
#[allow(clippy::struct_field_names)]
#[derive(Default)]
pub struct Charges12Builder {
...
impl Charges12Builder {
    /// Set the `amt` field.
    #[must_use]
    pub fn amt(mut self, value: ActiveOrHistoricCurrencyAndAmount) -> Charges12Builder {
        self.amt = ::std::option::Option::Some(value);
        self
    }
    /// Set the `agt` field.
    #[must_use]
    pub fn agt(mut self, value: BranchAndFinancialInstitutionIdentification6) -> Charges12Builder {
    ...
    /// Does not panic — all `.unwrap()` calls are guarded by the
    /// missing-field check above.
    pub fn build(self) -> ::std::result::Result<Charges12, crate::common::BuilderError> {
        let mut missing: ::std::vec::Vec<::std::string::String> = ::std::vec::Vec::new();
        if self.amt.is_none() {
        ...
        if !missing.is_empty() {
            return ::std::result::Result::Err(crate::common::BuilderError {
                type_name: "Charges12".to_owned(),
                missing_fields: missing,
            });
        }
        ::std::result::Result::Ok(Charges12 {
            amt: self.amt.unwrap(),
            agt: self.agt.unwrap(),
            tp: self.tp,
        })
...
impl Charges12 {
    /// Return a new builder for this type.
    #[must_use]
    pub fn builder() -> Charges12Builder {
        Charges12Builder::default()
    }
}
#[allow(clippy::large_enum_variant)]
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize)]
...
/// Builder for [`CurrencyExchange13`]. Construct via [`CurrencyExchange13::builder()`].
#[allow(clippy::struct_field_names)]
#[derive(Default)]
pub struct CurrencyExchange13Builder {
    src_ccy: ::std::option::Option<ActiveCurrencyCode>,
    trgt_ccy: ::std::option::Option<ActiveCurrencyCode>,
    xchg_rate: ::std::option::Option<BaseOneRate>,
    unit_ccy: ::std::option::Option<ActiveCurrencyCode>,
}
impl CurrencyExchange13Builder {
    /// Set the `src_ccy` field.
    #[must_use]
    pub fn src_ccy(mut self, value: ActiveCurrencyCode) -> CurrencyExchange13Builder {
        self.src_ccy = ::std::option::Option::Some(value);
        self
    }
    /// Set the `trgt_ccy` field.
    #[must_use]
    pub fn trgt_ccy(mut self, value: ActiveCurrencyCode) -> CurrencyExchange13Builder {
        self.trgt_ccy = ::std::option::Option::Some(value);
        self
    }
    /// Set the `xchg_rate` field.
    #[must_use]
    pub fn xchg_rate(mut self, value: BaseOneRate) -> CurrencyExchange13Builder {
        self.xchg_rate = ::std::option::Option::Some(value);
        self
    }
    /// Set the `unit_ccy` field.
    #[must_use]
    pub fn unit_ccy(mut self, value: ActiveCurrencyCode) -> CurrencyExchange13Builder {
    ...
    /// Does not panic — all `.unwrap()` calls are guarded by the
    /// missing-field check above.
    pub fn build(self) -> ::std::result::Result<CurrencyExchange13, crate::common::BuilderError> {
        let mut missing: ::std::vec::Vec<::std::string::String> = ::std::vec::Vec::new();
        if self.src_ccy.is_none() {
            missing.push("src_ccy".to_owned());
        }
        if self.trgt_ccy.is_none() {
            missing.push("trgt_ccy".to_owned());
        }
        ...
        if !missing.is_empty() {
            return ::std::result::Result::Err(crate::common::BuilderError {
                type_name: "CurrencyExchange13".to_owned(),
                missing_fields: missing,
            });
        }
        ::std::result::Result::Ok(CurrencyExchange13 {
            src_ccy: self.src_ccy.unwrap(),
            trgt_ccy: self.trgt_ccy.unwrap(),
...
impl CurrencyExchange13 {
    /// Return a new builder for this type.
    #[must_use]
    pub fn builder() -> CurrencyExchange13Builder {
        CurrencyExchange13Builder::default()
    }
}
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize)]
pub struct CustomerPaymentStatusReportV13 {
    #[serde(rename = "GrpHdr")]
    ...
    #[serde(default)]
    #[serde(skip_serializing_if = "Vec::is_empty")]
    pub orgnl_pmt_inf_and_sts: Vec<OriginalPaymentInstruction45>,
    #[serde(rename = "SplmtryData")]
    #[serde(default)]
    #[serde(skip_serializing_if = "Vec::is_empty")]
    pub splmtry_data: Vec<SupplementaryData1>,
}
/// Builder for [`CustomerPaymentStatusReportV13`]. Construct via [`CustomerPaymentStatusReportV13::builder()`].
#[allow(clippy::struct_field_names)]
#[derive(Default)]
pub struct CustomerPaymentStatusReportV13Builder {
    grp_hdr: ::std::option::Option<GroupHeader86>,
    orgnl_grp_inf_and_sts: ::std::option::Option<OriginalGroupHeader17>,
    orgnl_pmt_inf_and_sts: ::std::vec::Vec<OriginalPaymentInstruction45>,
    splmtry_data: ::std::vec::Vec<SupplementaryData1>,
}
impl CustomerPaymentStatusReportV13Builder {
    /// Set the `grp_hdr` field.
    #[must_use]
    pub fn grp_hdr(mut self, value: GroupHeader86) -> CustomerPaymentStatusReportV13Builder {
    ...
    ) -> CustomerPaymentStatusReportV13Builder {
    ...
    pub fn orgnl_pmt_inf_and_sts(
        mut self,
        value: ::std::vec::Vec<OriginalPaymentInstruction45>,
    ) -> CustomerPaymentStatusReportV13Builder {
    ...
    pub fn add_orgnl_pmt_inf_and_sts(
        mut self,
        value: OriginalPaymentInstruction45,
    ) -> CustomerPaymentStatusReportV13Builder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<CustomerPaymentStatusReportV13, crate::common::BuilderError> {
        let mut missing: ::std::vec::Vec<::std::string::String> = ::std::vec::Vec::new();
        if self.grp_hdr.is_none() {
            missing.push("grp_hdr".to_owned());
        }
        if self.orgnl_grp_inf_and_sts.is_none() {
            missing.push("orgnl_grp_inf_and_sts".to_owned());
        }
        if !missing.is_empty() {
            return ::std::result::Result::Err(crate::common::BuilderError {
                type_name: "CustomerPaymentStatusReportV13".to_owned(),
                missing_fields: missing,
            });
        }
        ::std::result::Result::Ok(CustomerPaymentStatusReportV13 {
            grp_hdr: self.grp_hdr.unwrap(),
            orgnl_grp_inf_and_sts: self.orgnl_grp_inf_and_sts.unwrap(),
            orgnl_pmt_inf_and_sts: self.orgnl_pmt_inf_and_sts,
            splmtry_data: self.splmtry_data,
        })
    }
}
impl CustomerPaymentStatusReportV13 {
    /// Return a new builder for this type.
    #[must_use]
    pub fn builder() -> CustomerPaymentStatusReportV13Builder {
        CustomerPaymentStatusReportV13Builder::default()
    }
}
#[allow(clippy::large_enum_variant)]
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize)]
...
pub struct Document {
    ...
    pub cstmr_pmt_sts_rpt: CustomerPaymentStatusReportV13,
}
/// Builder for [`Document`]. Construct via [`Document::builder()`].
#[allow(clippy::struct_field_names)]
#[derive(Default)]
pub struct DocumentBuilder {
    cstmr_pmt_sts_rpt: ::std::option::Option<CustomerPaymentStatusReportV13>,
}
impl DocumentBuilder {
    /// Set the `cstmr_pmt_sts_rpt` field.
    #[must_use]
    pub fn cstmr_pmt_sts_rpt(mut self, value: CustomerPaymentStatusReportV13) -> DocumentBuilder {
        self.cstmr_pmt_sts_rpt = ::std::option::Option::Some(value);
        self
    }
    /// Validate required fields and construct the type.
    ///
    ...
    pub fn build(self) -> ::std::result::Result<Document, crate::common::BuilderError> {
        let mut missing: ::std::vec::Vec<::std::string::String> = ::std::vec::Vec::new();
        if self.cstmr_pmt_sts_rpt.is_none() {
            missing.push("cstmr_pmt_sts_rpt".to_owned());
        }
        if !missing.is_empty() {
            return ::std::result::Result::Err(crate::common::BuilderError {
        ...
        ::std::result::Result::Ok(Document {
            cstmr_pmt_sts_rpt: self.cstmr_pmt_sts_rpt.unwrap(),
        })
    }
}
impl Document {
...
/// Builder for [`GroupHeader86`]. Construct via [`GroupHeader86::builder()`].
#[allow(clippy::struct_field_names)]
#[derive(Default)]
pub struct GroupHeader86Builder {
...
impl GroupHeader86Builder {
    /// Set the `msg_id` field.
    #[must_use]
    pub fn msg_id(mut self, value: Max35Text) -> GroupHeader86Builder {
        self.msg_id = ::std::option::Option::Some(value);
        self
    }
    /// Set the `cre_dt_tm` field.
    #[must_use]
    pub fn cre_dt_tm(mut self, value: ISODateTime) -> GroupHeader86Builder {
        self.cre_dt_tm = ::std::option::Option::Some(value);
        self
    }
    /// Set the `initg_pty` field.
    #[must_use]
    pub fn initg_pty(mut self, value: PartyIdentification135) -> GroupHeader86Builder {
    ...
    /// Does not panic — all `.unwrap()` calls are guarded by the
    /// missing-field check above.
    pub fn build(self) -> ::std::result::Result<GroupHeader86, crate::common::BuilderError> {
        let mut missing: ::std::vec::Vec<::std::string::String> = ::std::vec::Vec::new();
        ...
        if !missing.is_empty() {
            return ::std::result::Result::Err(crate::common::BuilderError {
                type_name: "GroupHeader86".to_owned(),
                missing_fields: missing,
            });
        }
        ::std::result::Result::Ok(GroupHeader86 {
...
impl GroupHeader86 {
    /// Return a new builder for this type.
    #[must_use]
    pub fn builder() -> GroupHeader86Builder {
        GroupHeader86Builder::default()
    }
}
#[allow(clippy::large_enum_variant)]
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize)]
...
impl OriginalGroupHeader17Builder {
    ...
    #[must_use]
    pub fn orgnl_cre_dt_tm(mut self, value: ISODateTime) -> OriginalGroupHeader17Builder {
        self.orgnl_cre_dt_tm = ::std::option::Option::Some(value);
        self
    }
    /// Set the `orgnl_nb_of_txs` field.
    #[must_use]
    pub fn orgnl_nb_of_txs(mut self, value: Max15NumericText) -> OriginalGroupHeader17Builder {
        self.orgnl_nb_of_txs = ::std::option::Option::Some(value);
        self
    }
    /// Set the `orgnl_ctrl_sum` field.
    #[must_use]
    pub fn orgnl_ctrl_sum(mut self, value: DecimalNumber) -> OriginalGroupHeader17Builder {
...
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize)]
pub struct OriginalPaymentInstruction45 {
    ...
    #[serde(default)]
    #[serde(skip_serializing_if = "Vec::is_empty")]
    pub tx_inf_and_sts: Vec<PaymentTransaction144>,
}
/// Builder for [`OriginalPaymentInstruction45`]. Construct via [`OriginalPaymentInstruction45::builder()`].
#[allow(clippy::struct_field_names)]
#[derive(Default)]
pub struct OriginalPaymentInstruction45Builder {
    orgnl_pmt_inf_id: ::std::option::Option<Max35Text>,
    orgnl_nb_of_txs: ::std::option::Option<Max15NumericText>,
    orgnl_ctrl_sum: ::std::option::Option<DecimalNumber>,
    pmt_inf_sts: ::std::option::Option<ExternalPaymentGroupStatus1Code>,
    sts_rsn_inf: ::std::vec::Vec<StatusReasonInformation12>,
    nb_of_txs_per_sts: ::std::vec::Vec<NumberOfTransactionsPerStatus5>,
    tx_inf_and_sts: ::std::vec::Vec<PaymentTransaction144>,
}
impl OriginalPaymentInstruction45Builder {
    /// Set the `orgnl_pmt_inf_id` field.
    #[must_use]
    pub fn orgnl_pmt_inf_id(mut self, value: Max35Text) -> OriginalPaymentInstruction45Builder {
    ...
    pub fn orgnl_nb_of_txs(
        mut self,
        value: Max15NumericText,
    ) -> OriginalPaymentInstruction45Builder {
        self.orgnl_nb_of_txs = ::std::option::Option::Some(value);
        self
    }
    /// Set the `orgnl_ctrl_sum` field.
    #[must_use]
    pub fn orgnl_ctrl_sum(mut self, value: DecimalNumber) -> OriginalPaymentInstruction45Builder {
        self.orgnl_ctrl_sum = ::std::option::Option::Some(value);
        self
    }
    /// Set the `pmt_inf_sts` field.
    #[must_use]
    pub fn pmt_inf_sts(
        mut self,
        value: ExternalPaymentGroupStatus1Code,
    ) -> OriginalPaymentInstruction45Builder {
        self.pmt_inf_sts = ::std::option::Option::Some(value);
        self
    }
    /// Set the `sts_rsn_inf` field (replaces any previously added items).
    #[must_use]
    ...
    pub fn tx_inf_and_sts(
        mut self,
        value: ::std::vec::Vec<PaymentTransaction144>,
    ) -> OriginalPaymentInstruction45Builder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<OriginalPaymentInstruction45, crate::common::BuilderError> {
        let mut missing: ::std::vec::Vec<::std::string::String> = ::std::vec::Vec::new();
        ...
        if !missing.is_empty() {
            return ::std::result::Result::Err(crate::common::BuilderError {
                type_name: "OriginalPaymentInstruction45".to_owned(),
                missing_fields: missing,
            });
        }
        ::std::result::Result::Ok(OriginalPaymentInstruction45 {
            orgnl_pmt_inf_id: self.orgnl_pmt_inf_id.unwrap(),
            orgnl_nb_of_txs: self.orgnl_nb_of_txs,
            orgnl_ctrl_sum: self.orgnl_ctrl_sum,
            pmt_inf_sts: self.pmt_inf_sts,
            sts_rsn_inf: self.sts_rsn_inf,
            nb_of_txs_per_sts: self.nb_of_txs_per_sts,
...
impl OriginalPaymentInstruction45 {
    /// Return a new builder for this type.
    #[must_use]
    pub fn builder() -> OriginalPaymentInstruction45Builder {
        OriginalPaymentInstruction45Builder::default()
    }
}
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize)]
...
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize)]
pub struct PaymentTransaction144 {
    #[serde(rename = "StsId")]
    #[serde(skip_serializing_if = "Option::is_none")]
...
/// Builder for [`PaymentTransaction144`]. Construct via [`PaymentTransaction144::builder()`].
#[allow(clippy::struct_field_names)]
#[derive(Default)]
pub struct PaymentTransaction144Builder {
    ...
    sts_rsn_inf: ::std::vec::Vec<StatusReasonInformation12>,
    chrgs_inf: ::std::vec::Vec<Charges12>,
    trckr_data: ::std::option::Option<TrackerData1>,
...
impl PaymentTransaction144Builder {
    /// Set the `sts_id` field.
    #[must_use]
    pub fn sts_id(mut self, value: Max35Text) -> PaymentTransaction144Builder {
        self.sts_id = ::std::option::Option::Some(value);
        self
    }
    /// Set the `orgnl_instr_id` field.
    #[must_use]
    pub fn orgnl_instr_id(mut self, value: Max35Text) -> PaymentTransaction144Builder {
        self.orgnl_instr_id = ::std::option::Option::Some(value);
        self
    }
    /// Set the `orgnl_end_to_end_id` field.
    #[must_use]
    pub fn orgnl_end_to_end_id(mut self, value: Max35Text) -> PaymentTransaction144Builder {
        self.orgnl_end_to_end_id = ::std::option::Option::Some(value);
        self
    }
    /// Set the `orgnl_uetr` field.
    #[must_use]
    pub fn orgnl_uetr(mut self, value: UUIDv4Identifier) -> PaymentTransaction144Builder {
    ...
    #[must_use]
    pub fn chrgs_inf(mut self, value: ::std::vec::Vec<Charges12>) -> PaymentTransaction144Builder {
        self.chrgs_inf = value;
        self
    }
    /// Append one item to the `chrgs_inf` field.
    #[must_use]
    pub fn add_chrgs_inf(mut self, value: Charges12) -> PaymentTransaction144Builder {
        self.chrgs_inf.push(value);
        self
    }
    /// Set the `trckr_data` field.
    #[must_use]
    pub fn trckr_data(mut self, value: TrackerData1) -> PaymentTransaction144Builder {
        self.trckr_data = ::std::option::Option::Some(value);
        self
    }
    /// Set the `accptnc_dt_tm` field.
    #[must_use]
    pub fn accptnc_dt_tm(mut self, value: ISODateTime) -> PaymentTransaction144Builder {
        self.accptnc_dt_tm = ::std::option::Option::Some(value);
        self
    }
    /// Set the `acct_svcr_ref` field.
    #[must_use]
    pub fn acct_svcr_ref(mut self, value: Max35Text) -> PaymentTransaction144Builder {
        self.acct_svcr_ref = ::std::option::Option::Some(value);
        self
    }
    /// Set the `clr_sys_ref` field.
    #[must_use]
    pub fn clr_sys_ref(mut self, value: Max35Text) -> PaymentTransaction144Builder {
    ...
    /// Append one item to the `splmtry_data` field.
    #[must_use]
    pub fn add_splmtry_data(mut self, value: SupplementaryData1) -> PaymentTransaction144Builder {
        self.splmtry_data.push(value);
        self
    }
    /// Validate required fields and construct the type.
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<PaymentTransaction144, crate::common::BuilderError> {
        ::std::result::Result::Ok(PaymentTransaction144 {
            sts_id: self.sts_id,
...
impl PaymentTransaction144 {
    /// Return a new builder for this type.
    #[must_use]
    pub fn builder() -> PaymentTransaction144Builder {
        PaymentTransaction144Builder::default()
    }
}
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize)]
...
impl StatusReasonInformation12Builder {
    /// Set the `orgtr` field.
    #[must_use]
    pub fn orgtr(mut self, value: PartyIdentification135) -> StatusReasonInformation12Builder {
    ...
    #[must_use]
    pub fn add_addtl_inf(mut self, value: Max105Text) -> StatusReasonInformation12Builder {
...
pub struct TrackerData1 {
    ...
    pub confd_dt: crate::common::ChoiceWrapper<DateAndDateTime2Choice>,
...
/// Builder for [`TrackerData1`]. Construct via [`TrackerData1::builder()`].
#[allow(clippy::struct_field_names)]
#[derive(Default)]
pub struct TrackerData1Builder {
    confd_dt: ::std::option::Option<crate::common::ChoiceWrapper<DateAndDateTime2Choice>>,
    confd_amt: ::std::option::Option<ActiveCurrencyAndAmount>,
    trckr_rcrd: ::std::vec::Vec<TrackerRecord1>,
}
impl TrackerData1Builder {
    /// Set the `confd_dt` field.
    #[must_use]
    pub fn confd_dt(
        mut self,
        value: crate::common::ChoiceWrapper<DateAndDateTime2Choice>,
    ) -> TrackerData1Builder {
        self.confd_dt = ::std::option::Option::Some(value);
        self
    }
    /// Set the `confd_amt` field.
    #[must_use]
    pub fn confd_amt(mut self, value: ActiveCurrencyAndAmount) -> TrackerData1Builder {
        self.confd_amt = ::std::option::Option::Some(value);
        self
    }
    /// Set the `trckr_rcrd` field (replaces any previously added items).
    #[must_use]
    pub fn trckr_rcrd(mut self, value: ::std::vec::Vec<TrackerRecord1>) -> TrackerData1Builder {
        self.trckr_rcrd = value;
        self
    }
    /// Append one item to the `trckr_rcrd` field.
    #[must_use]
    pub fn add_trckr_rcrd(mut self, value: TrackerRecord1) -> TrackerData1Builder {
        self.trckr_rcrd.push(value);
        self
    }
    /// Validate required fields and construct the type.
    ///
    ...
    /// Does not panic — all `.unwrap()` calls are guarded by the
    /// missing-field check above.
    pub fn build(self) -> ::std::result::Result<TrackerData1, crate::common::BuilderError> {
        let mut missing: ::std::vec::Vec<::std::string::String> = ::std::vec::Vec::new();
        if self.confd_dt.is_none() {
            missing.push("confd_dt".to_owned());
        }
        if self.confd_amt.is_none() {
            missing.push("confd_amt".to_owned());
        }
        if !missing.is_empty() {
            return ::std::result::Result::Err(crate::common::BuilderError {
                type_name: "TrackerData1".to_owned(),
                missing_fields: missing,
            });
        }
        ::std::result::Result::Ok(TrackerData1 {
            confd_dt: self.confd_dt.unwrap(),
            confd_amt: self.confd_amt.unwrap(),
            trckr_rcrd: self.trckr_rcrd,
        })
    }
}
impl TrackerData1 {
    /// Return a new builder for this type.
    #[must_use]
    pub fn builder() -> TrackerData1Builder {
        TrackerData1Builder::default()
    }
}
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize)]
pub struct TrackerRecord1 {
    ...
    #[serde(rename = "ChrgsAmt")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub chrgs_amt: Option<ActiveCurrencyAndAmount>,
    #[serde(rename = "XchgRateData")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub xchg_rate_data: Option<CurrencyExchange13>,
}
/// Builder for [`TrackerRecord1`]. Construct via [`TrackerRecord1::builder()`].
#[allow(clippy::struct_field_names)]
#[derive(Default)]
pub struct TrackerRecord1Builder {
    agt: ::std::option::Option<BranchAndFinancialInstitutionIdentification6>,
    chrg_br: ::std::option::Option<ChargeBearerType1Code>,
    chrgs_amt: ::std::option::Option<ActiveCurrencyAndAmount>,
    xchg_rate_data: ::std::option::Option<CurrencyExchange13>,
}
impl TrackerRecord1Builder {
    /// Set the `agt` field.
    #[must_use]
    pub fn agt(
        mut self,
        value: BranchAndFinancialInstitutionIdentification6,
    ) -> TrackerRecord1Builder {
        self.agt = ::std::option::Option::Some(value);
        self
    }
    /// Set the `chrg_br` field.
    #[must_use]
    pub fn chrg_br(mut self, value: ChargeBearerType1Code) -> TrackerRecord1Builder {
        self.chrg_br = ::std::option::Option::Some(value);
        self
    }
    /// Set the `chrgs_amt` field.
    #[must_use]
    pub fn chrgs_amt(mut self, value: ActiveCurrencyAndAmount) -> TrackerRecord1Builder {
        self.chrgs_amt = ::std::option::Option::Some(value);
        self
    }
    /// Set the `xchg_rate_data` field.
    #[must_use]
    pub fn xchg_rate_data(mut self, value: CurrencyExchange13) -> TrackerRecord1Builder {
        self.xchg_rate_data = ::std::option::Option::Some(value);
        self
    }
    /// Validate required fields and construct the type.
    ///
    ...
    /// Does not panic — all `.unwrap()` calls are guarded by the
    /// missing-field check above.
    pub fn build(self) -> ::std::result::Result<TrackerRecord1, crate::common::BuilderError> {
        let mut missing: ::std::vec::Vec<::std::string::String> = ::std::vec::Vec::new();
        if self.agt.is_none() {
            missing.push("agt".to_owned());
        }
        if !missing.is_empty() {
            return ::std::result::Result::Err(crate::common::BuilderError {
                type_name: "TrackerRecord1".to_owned(),
                missing_fields: missing,
            });
        }
        ::std::result::Result::Ok(TrackerRecord1 {
            agt: self.agt.unwrap(),
            chrg_br: self.chrg_br,
            chrgs_amt: self.chrgs_amt,
            xchg_rate_data: self.xchg_rate_data,
        })
    }
}
impl TrackerRecord1 {
    /// Return a new builder for this type.
    #[must_use]
    pub fn builder() -> TrackerRecord1Builder {
        TrackerRecord1Builder::default()
    }
}
...
impl crate::common::validate::Validatable for Charges12 {
    fn validate_constraints(
        &self,
        path: &str,
        violations: &mut Vec<crate::common::validate::ConstraintViolation>,
...
impl crate::common::validate::Validatable for CurrencyExchange13 {
    fn validate_constraints(
        &self,
        path: &str,
        violations: &mut Vec<crate::common::validate::ConstraintViolation>,
        ...
        {
            let snap = violations.len();
            self.src_ccy.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/SrcCcy");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        {
            let snap = violations.len();
            self.trgt_ccy.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/TrgtCcy");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        {
            let snap = violations.len();
            self.xchg_rate.validate_constraints("", violations);
            if violations.len() > snap {
...
impl crate::common::validate::Validatable for CustomerPaymentStatusReportV13 {
    fn validate_constraints(
        &self,
        path: &str,
        violations: &mut Vec<crate::common::validate::ConstraintViolation>,
        ...
        {
            let snap = violations.len();
            self.orgnl_grp_inf_and_sts
                .validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/OrgnlGrpInfAndSts");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        }
        for (idx, elem) in self.orgnl_pmt_inf_and_sts.iter().enumerate() {
            let snap = violations.len();
            elem.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/OrgnlPmtInfAndSts[{idx}]");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
...
impl crate::common::validate::Validatable for Document {
    fn validate_constraints(
        ...
        {
            let snap = violations.len();
            self.cstmr_pmt_sts_rpt.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/CstmrPmtStsRpt");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
...
impl crate::common::validate::Validatable for GroupHeader86 {
    fn validate_constraints(
        &self,
        path: &str,
        violations: &mut Vec<crate::common::validate::ConstraintViolation>,
...
impl crate::common::validate::Validatable for OriginalPaymentInstruction45 {
    fn validate_constraints(
        &self,
        path: &str,
        violations: &mut Vec<crate::common::validate::ConstraintViolation>,
        ...
        {
            let snap = violations.len();
            self.orgnl_pmt_inf_id.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/OrgnlPmtInfId");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
...
impl crate::common::validate::Validatable for PaymentTransaction144 {
    fn validate_constraints(
        &self,
        path: &str,
        violations: &mut Vec<crate::common::validate::ConstraintViolation>,
        ...
        if let Some(ref val) = self.trckr_data {
            let snap = violations.len();
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/TrckrData");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
...
impl crate::common::validate::Validatable for TrackerData1 {
    fn validate_constraints(
        &self,
        path: &str,
        violations: &mut Vec<crate::common::validate::ConstraintViolation>,
        ...
        {
            let snap = violations.len();
            self.confd_dt.inner.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/ConfdDt");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        {
            let snap = violations.len();
            self.confd_amt.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/ConfdAmt");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        }
        for (idx, elem) in self.trckr_rcrd.iter().enumerate() {
            let snap = violations.len();
            elem.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/TrckrRcrd[{idx}]");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
...
impl crate::common::validate::Validatable for TrackerRecord1 {
    fn validate_constraints(
        &self,
        path: &str,
        violations: &mut Vec<crate::common::validate::ConstraintViolation>,
        ...
        if let Some(ref val) = self.chrgs_amt {
            let snap = violations.len();
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/ChrgsAmt");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        }
        if let Some(ref val) = self.xchg_rate_data {
            let snap = violations.len();
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/XchgRateData");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
