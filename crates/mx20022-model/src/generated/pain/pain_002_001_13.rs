...
impl crate::common::validate::Validatable for CurrencyExchange13 {
    fn validate_constraints(
        ...
        self.trgt_ccy
            .validate_constraints(&format!("{path}/TrgtCcy"), violations);
        self.xchg_rate
...
impl crate::common::validate::Validatable for CustomerPaymentStatusReportV13 {
    fn validate_constraints(
        ...
        self.orgnl_grp_inf_and_sts
            .validate_constraints(&format!("{path}/OrgnlGrpInfAndSts"), violations);
...
impl crate::common::validate::Validatable for Document {
    fn validate_constraints(
        ...
        self.cstmr_pmt_sts_rpt
            .validate_constraints(&format!("{path}/CstmrPmtStsRpt"), violations);
    }
}
...
impl crate::common::validate::Validatable for OriginalPaymentInstruction45 {
    fn validate_constraints(
        ...
        if let Some(ref val) = self.pmt_inf_sts {
            val.validate_constraints(&format!("{path}/PmtInfSts"), violations);
        }
        for (i, item) in self.sts_rsn_inf.iter().enumerate() {
            item.validate_constraints(&format!("{path}/StsRsnInf[{i}]"), violations);
        }
...
impl crate::common::validate::Validatable for PaymentTransaction144 {
    fn validate_constraints(
        ...
        if let Some(ref val) = self.trckr_data {
            val.validate_constraints(&format!("{path}/TrckrData"), violations);
        }
...
impl crate::common::validate::Validatable for TrackerData1 {
    fn validate_constraints(
        ...
        self.confd_dt
            .inner
            .validate_constraints(&format!("{path}/ConfdDt"), violations);
        self.confd_amt
            .validate_constraints(&format!("{path}/ConfdAmt"), violations);
        for (i, item) in self.trckr_rcrd.iter().enumerate() {
            item.validate_constraints(&format!("{path}/TrckrRcrd[{i}]"), violations);
        }
    }
}
impl crate::common::validate::Validatable for TrackerRecord1 {
    fn validate_constraints(
        ...
        if let Some(ref val) = self.chrgs_amt {
            val.validate_constraints(&format!("{path}/ChrgsAmt"), violations);
        }
        if let Some(ref val) = self.xchg_rate_data {
            val.validate_constraints(&format!("{path}/XchgRateData"), violations);
        }
    }
}
