...
impl crate::common::validate::Validatable for Document {
    fn validate_constraints(
        ...
        {
            let snap = violations.len();
            self.pmt_rtr.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/PmtRtr");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
...
impl crate::common::validate::Validatable for GroupHeader99 {
    fn validate_constraints(
        &self,
        path: &str,
        violations: &mut Vec<crate::common::validate::ConstraintViolation>,
        ...
        for (idx, elem) in self.authstn.iter().enumerate() {
            let snap = violations.len();
            elem.inner.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/Authstn[{idx}]");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.grp_rtr {
            let snap = violations.len();
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/GrpRtr");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        }
        if let Some(ref val) = self.ttl_rtrd_intr_bk_sttlm_amt {
            let snap = violations.len();
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/TtlRtrdIntrBkSttlmAmt");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
...
impl crate::common::validate::Validatable for OriginalGroupHeader18 {
    fn validate_constraints(
        &self,
        path: &str,
        violations: &mut Vec<crate::common::validate::ConstraintViolation>,
        ...
        for (idx, elem) in self.rtr_rsn_inf.iter().enumerate() {
            let snap = violations.len();
            elem.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/RtrRsnInf[{idx}]");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
...
impl crate::common::validate::Validatable for OriginalTransactionReference36 {
    fn validate_constraints(
        &self,
        path: &str,
        violations: &mut Vec<crate::common::validate::ConstraintViolation>,
...
impl crate::common::validate::Validatable for PaymentReturnReason6 {
    fn validate_constraints(
        &self,
        path: &str,
        violations: &mut Vec<crate::common::validate::ConstraintViolation>,
...
impl crate::common::validate::Validatable for PaymentReturnV11 {
    fn validate_constraints(
        &self,
        path: &str,
        violations: &mut Vec<crate::common::validate::ConstraintViolation>,
...
impl crate::common::validate::Validatable for PaymentTransaction133 {
    fn validate_constraints(
        &self,
        path: &str,
        violations: &mut Vec<crate::common::validate::ConstraintViolation>,
        ...
        {
            let snap = violations.len();
            self.rtrd_intr_bk_sttlm_amt
                .validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/RtrdIntrBkSttlmAmt");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.rtrd_instd_amt {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/RtrdInstdAmt");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.compstn_amt {
            let snap = violations.len();
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/CompstnAmt");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.rtr_chain {
            let snap = violations.len();
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/RtrChain");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
...
impl crate::common::validate::Validatable for TransactionParties10 {
    fn validate_constraints(
        &self,
        path: &str,
        violations: &mut Vec<crate::common::validate::ConstraintViolation>,
        ...
        {
            let snap = violations.len();
            self.dbtr.inner.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/Dbtr");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
        ...
        {
            let snap = violations.len();
            self.cdtr.inner.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/Cdtr");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
