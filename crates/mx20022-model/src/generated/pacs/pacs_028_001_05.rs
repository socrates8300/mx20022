...
pub struct DocumentBuilder {
    fi_to_fi_pmt_sts_req: ::std::option::Option<FIToFIPaymentStatusRequestV05>,
}
impl DocumentBuilder {
    /// Set the `fi_to_fi_pmt_sts_req` field.
    #[must_use]
    pub fn fi_to_fi_pmt_sts_req(mut self, value: FIToFIPaymentStatusRequestV05) -> DocumentBuilder {
        self.fi_to_fi_pmt_sts_req = ::std::option::Option::Some(value);
        self
    }
    /// Validate required fields and construct the type.
    ///
    ...
    pub fn build(self) -> ::std::result::Result<Document, crate::common::BuilderError> {
        let mut missing: ::std::vec::Vec<::std::string::String> = ::std::vec::Vec::new();
        if self.fi_to_fi_pmt_sts_req.is_none() {
            missing.push("fi_to_fi_pmt_sts_req".to_owned());
        }
        if !missing.is_empty() {
            return ::std::result::Result::Err(crate::common::BuilderError {
        ...
        ::std::result::Result::Ok(Document {
            fi_to_fi_pmt_sts_req: self.fi_to_fi_pmt_sts_req.unwrap(),
        })
    }
}
impl Document {
...
/// Builder for [`FIToFIPaymentStatusRequestV05`]. Construct via [`FIToFIPaymentStatusRequestV05::builder()`].
#[allow(clippy::struct_field_names)]
#[derive(Default)]
pub struct FIToFIPaymentStatusRequestV05Builder {
    grp_hdr: ::std::option::Option<GroupHeader91>,
    orgnl_grp_inf: ::std::vec::Vec<OriginalGroupInformation27>,
    tx_inf: ::std::vec::Vec<PaymentTransaction131>,
    splmtry_data: ::std::vec::Vec<SupplementaryData1>,
}
impl FIToFIPaymentStatusRequestV05Builder {
    /// Set the `grp_hdr` field.
    #[must_use]
    pub fn grp_hdr(mut self, value: GroupHeader91) -> FIToFIPaymentStatusRequestV05Builder {
        self.grp_hdr = ::std::option::Option::Some(value);
        self
    }
    /// Set the `orgnl_grp_inf` field (replaces any previously added items).
    #[must_use]
    pub fn orgnl_grp_inf(
        mut self,
        value: ::std::vec::Vec<OriginalGroupInformation27>,
    ) -> FIToFIPaymentStatusRequestV05Builder {
        self.orgnl_grp_inf = value;
        self
    }
    /// Append one item to the `orgnl_grp_inf` field.
    #[must_use]
    pub fn add_orgnl_grp_inf(
        mut self,
        value: OriginalGroupInformation27,
    ) -> FIToFIPaymentStatusRequestV05Builder {
        self.orgnl_grp_inf.push(value);
        self
    }
    ...
    pub fn tx_inf(
        mut self,
        value: ::std::vec::Vec<PaymentTransaction131>,
    ) -> FIToFIPaymentStatusRequestV05Builder {
        self.tx_inf = value;
        self
    }
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<FIToFIPaymentStatusRequestV05, crate::common::BuilderError> {
        let mut missing: ::std::vec::Vec<::std::string::String> = ::std::vec::Vec::new();
        ...
        if !missing.is_empty() {
            return ::std::result::Result::Err(crate::common::BuilderError {
                type_name: "FIToFIPaymentStatusRequestV05".to_owned(),
                missing_fields: missing,
            });
        }
        ::std::result::Result::Ok(FIToFIPaymentStatusRequestV05 {
...
impl FIToFIPaymentStatusRequestV05 {
    /// Return a new builder for this type.
    #[must_use]
    pub fn builder() -> FIToFIPaymentStatusRequestV05Builder {
        FIToFIPaymentStatusRequestV05Builder::default()
    }
}
#[allow(clippy::large_enum_variant)]
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize)]
...
impl GroupHeader91Builder {
    ...
    /// Does not panic — all `.unwrap()` calls are guarded by the
    /// missing-field check above.
    pub fn build(self) -> ::std::result::Result<GroupHeader91, crate::common::BuilderError> {
        let mut missing: ::std::vec::Vec<::std::string::String> = ::std::vec::Vec::new();
...
/// Builder for [`OriginalGroupInformation27`]. Construct via [`OriginalGroupInformation27::builder()`].
#[allow(clippy::struct_field_names)]
#[derive(Default)]
pub struct OriginalGroupInformation27Builder {
...
impl OriginalGroupInformation27Builder {
    /// Set the `orgnl_msg_id` field.
    #[must_use]
    pub fn orgnl_msg_id(mut self, value: Max35Text) -> OriginalGroupInformation27Builder {
        self.orgnl_msg_id = ::std::option::Option::Some(value);
        self
    }
    /// Set the `orgnl_msg_nm_id` field.
    #[must_use]
    pub fn orgnl_msg_nm_id(mut self, value: Max35Text) -> OriginalGroupInformation27Builder {
        self.orgnl_msg_nm_id = ::std::option::Option::Some(value);
        self
    }
    /// Set the `orgnl_cre_dt_tm` field.
    #[must_use]
    pub fn orgnl_cre_dt_tm(mut self, value: ISODateTime) -> OriginalGroupInformation27Builder {
        self.orgnl_cre_dt_tm = ::std::option::Option::Some(value);
        self
    }
    /// Set the `orgnl_nb_of_txs` field.
    #[must_use]
    pub fn orgnl_nb_of_txs(mut self, value: Max15NumericText) -> OriginalGroupInformation27Builder {
        self.orgnl_nb_of_txs = ::std::option::Option::Some(value);
        self
    }
    /// Set the `orgnl_ctrl_sum` field.
    #[must_use]
    pub fn orgnl_ctrl_sum(mut self, value: DecimalNumber) -> OriginalGroupInformation27Builder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<OriginalGroupInformation27, crate::common::BuilderError> {
        let mut missing: ::std::vec::Vec<::std::string::String> = ::std::vec::Vec::new();
        ...
        if !missing.is_empty() {
            return ::std::result::Result::Err(crate::common::BuilderError {
                type_name: "OriginalGroupInformation27".to_owned(),
                missing_fields: missing,
            });
        }
        ::std::result::Result::Ok(OriginalGroupInformation27 {
...
impl OriginalGroupInformation27 {
    /// Return a new builder for this type.
    #[must_use]
    pub fn builder() -> OriginalGroupInformation27Builder {
        OriginalGroupInformation27Builder::default()
    }
}
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize)]
...
/// Builder for [`PaymentTransaction131`]. Construct via [`PaymentTransaction131::builder()`].
#[allow(clippy::struct_field_names)]
#[derive(Default)]
pub struct PaymentTransaction131Builder {
    sts_req_id: ::std::option::Option<Max35Text>,
...
impl PaymentTransaction131Builder {
    /// Set the `sts_req_id` field.
    #[must_use]
    pub fn sts_req_id(mut self, value: Max35Text) -> PaymentTransaction131Builder {
        self.sts_req_id = ::std::option::Option::Some(value);
        self
    }
    ...
    ) -> PaymentTransaction131Builder {
        self.orgnl_grp_inf = ::std::option::Option::Some(value);
        self
    }
    /// Set the `orgnl_instr_id` field.
    #[must_use]
    pub fn orgnl_instr_id(mut self, value: Max35Text) -> PaymentTransaction131Builder {
        self.orgnl_instr_id = ::std::option::Option::Some(value);
        self
    }
    /// Set the `orgnl_end_to_end_id` field.
    #[must_use]
    pub fn orgnl_end_to_end_id(mut self, value: Max35Text) -> PaymentTransaction131Builder {
        self.orgnl_end_to_end_id = ::std::option::Option::Some(value);
        self
    }
    /// Set the `orgnl_tx_id` field.
    #[must_use]
    pub fn orgnl_tx_id(mut self, value: Max35Text) -> PaymentTransaction131Builder {
        self.orgnl_tx_id = ::std::option::Option::Some(value);
        self
    }
    /// Set the `orgnl_uetr` field.
    #[must_use]
    pub fn orgnl_uetr(mut self, value: UUIDv4Identifier) -> PaymentTransaction131Builder {
        self.orgnl_uetr = ::std::option::Option::Some(value);
        self
    }
    /// Set the `accptnc_dt_tm` field.
    #[must_use]
    pub fn accptnc_dt_tm(mut self, value: ISODateTime) -> PaymentTransaction131Builder {
        self.accptnc_dt_tm = ::std::option::Option::Some(value);
        self
    }
    /// Set the `clr_sys_ref` field.
    #[must_use]
    pub fn clr_sys_ref(mut self, value: Max35Text) -> PaymentTransaction131Builder {
    ...
    /// Append one item to the `splmtry_data` field.
    #[must_use]
    pub fn add_splmtry_data(mut self, value: SupplementaryData1) -> PaymentTransaction131Builder {
        self.splmtry_data.push(value);
        self
    }
    /// Validate required fields and construct the type.
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<PaymentTransaction131, crate::common::BuilderError> {
        ::std::result::Result::Ok(PaymentTransaction131 {
            sts_req_id: self.sts_req_id,
            orgnl_grp_inf: self.orgnl_grp_inf,
...
impl PaymentTransaction131 {
    /// Return a new builder for this type.
    #[must_use]
    pub fn builder() -> PaymentTransaction131Builder {
        PaymentTransaction131Builder::default()
    }
}
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize)]
...
impl crate::common::validate::Validatable for Document {
    fn validate_constraints(
        ...
        self.fi_to_fi_pmt_sts_req
            .validate_constraints(&format!("{path}/FIToFIPmtStsReq"), violations);
    }
}
...
impl crate::common::validate::Validatable for FIToFIPaymentStatusRequestV05 {
    fn validate_constraints(
        &self,
        path: &str,
        violations: &mut Vec<crate::common::validate::ConstraintViolation>,
        ...
        for (i, item) in self.orgnl_grp_inf.iter().enumerate() {
            item.validate_constraints(&format!("{path}/OrgnlGrpInf[{i}]"), violations);
        }
...
impl crate::common::validate::Validatable for OriginalGroupInformation27 {
    fn validate_constraints(
        &self,
        path: &str,
        violations: &mut Vec<crate::common::validate::ConstraintViolation>,
...
impl crate::common::validate::Validatable for PaymentTransaction131 {
    fn validate_constraints(
        &self,
        path: &str,
        violations: &mut Vec<crate::common::validate::ConstraintViolation>,
        ...
        if let Some(ref val) = self.sts_req_id {
            val.validate_constraints(&format!("{path}/StsReqId"), violations);
        }
