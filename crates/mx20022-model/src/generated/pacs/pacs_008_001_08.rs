            ...
            }
            {
                ...
                if violated {
                    return Err(crate::common::validate::ConstraintError {
                        kind: crate::common::validate::ConstraintKind::MaxLength,
                        message: format!(
                            "{} (got {})", "value exceeds maximum length 10", len
                        ),
                    });
                }
            }
...
impl crate::common::validate::Validatable for CashAccount38 {
    fn validate_constraints(
        ...
        {
            let snap = violations.len();
            self.id.inner.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/Id");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
...
impl crate::common::validate::Validatable for CreditTransferTransaction39 {
    fn validate_constraints(
        ...
        {
            let snap = violations.len();
            self.intr_bk_sttlm_amt.validate_constraints("", violations);
            if violations.len() > snap {
        ...
        if let Some(ref val) = self.sttlm_tm_indctn {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/SttlmTmIndctn");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.sttlm_tm_req {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/SttlmTmReq");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.poolg_adjstmnt_dt {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/PoolgAdjstmntDt");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.prvs_instg_agt1 {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/PrvsInstgAgt1");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.prvs_instg_agt1acct {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/PrvsInstgAgt1Acct");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.prvs_instg_agt2 {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/PrvsInstgAgt2");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.prvs_instg_agt2acct {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/PrvsInstgAgt2Acct");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.prvs_instg_agt3 {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/PrvsInstgAgt3");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.prvs_instg_agt3acct {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/PrvsInstgAgt3Acct");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.intrmy_agt1acct {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/IntrmyAgt1Acct");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.intrmy_agt2acct {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/IntrmyAgt2Acct");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        if let Some(ref val) = self.intrmy_agt3acct {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/IntrmyAgt3Acct");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        for (idx, elem) in self.instr_for_nxt_agt.iter().enumerate() {
            let snap = violations.len();
            elem.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/InstrForNxtAgt[{idx}]");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
...
impl crate::common::validate::Validatable for Document {
    fn validate_constraints(
        ...
        {
            let snap = violations.len();
            self.fi_to_fi_cstmr_cdt_trf.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/FIToFICstmrCdtTrf");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
...
impl crate::common::validate::Validatable for FIToFICustomerCreditTransferV08 {
    fn validate_constraints(
        ...
        for (idx, elem) in self.cdt_trf_tx_inf.iter().enumerate() {
            let snap = violations.len();
            elem.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/CdtTrfTxInf[{idx}]");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
...
impl crate::common::validate::Validatable for GroupHeader93 {
    fn validate_constraints(
        ...
        if let Some(ref val) = self.ttl_intr_bk_sttlm_amt {
            ...
            val.validate_constraints("", violations);
            if violations.len() > snap {
                let pfx = format!("{path}/TtlIntrBkSttlmAmt");
                for v in &mut violations[snap..] {
                    v.path.insert_str(0, &pfx);
                }
            }
        ...
        {
            let snap = violations.len();
            self.sttlm_inf.validate_constraints("", violations);
            if violations.len() > snap {
